...
ALTER SEQUENCE public.appointments_appoinment_id_seq OWNED BY public.appointments.appoinment_id;
...
--
-- Name: appointments appoinment_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments ALTER COLUMN appoinment_id SET DEFAULT nextval('public.appointments_appoinment_id_seq'::regclass);
...
SELECT pg_catalog.setval('public.appointments_appoinment_id_seq', 13, true);
...
--
-- Name: appointments appointment_id; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointment_id PRIMARY KEY (appoinment_id);


--
-- Name: customers customer_id; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: services service_id; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
